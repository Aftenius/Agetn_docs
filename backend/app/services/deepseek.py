...
def analyze_contract(
    *,
    ...
    if rag_context.strip():
        rag_part = f"""
Фрагменты из корпуса договоров (ориентиры, не обязательны к цитированию):
---
{rag_context[:8000]}
---
...
def generate_contract_structure(
    *,
    ...
    if rag_context.strip():
        rag_part = (
            "\nРелевантные фрагменты из корпуса договоров (ориентиры формулировок, не копировать дословно без проверки):\n"
            f"---\n{rag_context[:12000]}\n---\n"
        )
